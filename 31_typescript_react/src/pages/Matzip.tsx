...
import { MatzipForm } from '../components/types/interface';
...
const GridDiv = styled.div`
  ...
  display: grid;
  place-items: center;
  grid-template-columns: 1fr 1fr 1fr; // fr=비율 (1:1:1)
...
export default function Matzip() {
  ...
  const [showGangdong, setGangdong] = useState(true);
  const [showMapo, setMapo] = useState(false);
  const [showDobong, setDobong] = useState(false);
